...
progressdir <- "/home/carleton/scratch/carleton/Alaska/Results/lamap_progress_alaska_30.txt"
rasterpath <- "/home/carleton/scratch/carleton/Alaska/Data/Rnd/Tiles/Tiles.30.tif"
outputpath <- "/home/carleton/scratch/carleton/Alaska/Results/tanana_lamap_pre10_30.tif"
...
load("./tanana_lamap_pre10.RData")
clusterEvalQ(cl,load("./tanana_lamap_pre10.RData"))
